...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GranCookie — Cookies Artesanais" },
      { name: "description", content: "Cookies artesanais feitos com carinho. Sabores clássicos, especiais e recheados. Peça online e receba na sua porta." },
